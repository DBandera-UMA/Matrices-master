...
public class Matriz {
    ...
    public static Matriz matrizInversa(Matriz aa){

        int r = (int) aa.getDimension().getHeight();
        int c = (int) aa.getDimension().getWidth();
      double a[][] = new double[r][c];

        for(int i = 0; i< aa.getDimension().getHeight(); i++){
            for(int j = 0; j< aa.getDimension().getWidth(); i++){
                a[i][j] = aa.datos[i][j];
            }
        }
        ...
        int n = (int) aa.getDimension().getHeight();
 ...
 // Perform backward substitutions
        ...
        Matriz matrizResultante = new Matriz(x.length, x[0].length, false);

        
        for(int i = 0; i< aa.getDimension().getHeight(); i++){
            for(int j = 0; j< aa.getDimension().getWidth(); i++){
                matrizResultante.datos[i][j] =  (int)x[i][j];
            }
        }
        return matrizResultante;
